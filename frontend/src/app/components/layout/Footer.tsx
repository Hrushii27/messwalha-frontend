...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-dark-900 text-white border-t border-white/5" style={{ background: '#0D1220' }}>
            <div className="container mx-auto px-4 py-12 sm:py-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 sm:gap-16">
                    ...
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/70 mb-6 sm:mb-8">Platform</h4>
                    ...
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/70 mb-6 sm:mb-8">Business</h4>
                        <ul className="space-y-4 text-sm font-black uppercase tracking-widest text-white/60">
                    ...
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/70 mb-6 sm:mb-8">Legal</h4>
                        <ul className="space-y-4 text-sm font-black uppercase tracking-widest text-white/60">
                ...
                <div className="mt-12 sm:mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 sm:gap-6">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/60">System Status: Operational</span>
                        </div>
                    </div>
                </div>
            </div>
